...
| PBO / CSCV (both strategies) | Done | `pbo_cscv.md` (`scripts/cscv.py`). Shipped ORB PBO **0.114** over 162 configs (not overfit, OOS Sharpe of pick +1.33; `scripts/orb_pbo_sweep.py`). Gap-Fill PBO 0.429 (overfit, held back). |
