...
- PBO/CSCV: computed for BOTH strategies (S=8, `scripts/cscv.py`). Shipped ORB PBO 0.114 over 162 configs (not overfit, OOS Sharpe of the pick +1.33); Gap-Fill PBO 0.43 (overfit, held back). See `validation/pbo_cscv.md`.
