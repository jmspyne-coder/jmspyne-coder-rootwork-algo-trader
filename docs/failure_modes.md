...
| Max account drawdown breach | Critical | **Handled.** 10% peak-to-current drawdown is a sticky halt requiring a manual `resume_trading` (`MAX_DRAWDOWN_PCT`). $500 on the $5k start, scales with equity. | Resolved |
